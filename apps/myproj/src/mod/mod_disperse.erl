...
-export([init/1, start_link/3, handle_call/3, handle_cast/2, handle_info/2, terminate/2, code_change/3]).
-include("common.hrl").
-include("record.hrl").
...
record_info_list(Info) ->
    ...
    if is_record(Info, server) -> NewFieldList = record_info(fields, server);
        ...
        is_record(Info, ets_base_goods_add_attribute) ->
            NewFieldList = record_info(fields, ets_base_goods_add_attribute);
        is_record(Info, ets_base_goods_suit_attribute) ->
            NewFieldList = record_info(fields, ets_base_goods_suit_attribute);
        ...
        is_record(Info, ets_base_goods_strengthen_anti) ->
            NewFieldList = record_info(fields, ets_base_goods_strengthen_anti);
        is_record(Info, ets_base_goods_strengthen_extra) ->
            NewFieldList = record_info(fields, ets_base_goods_strengthen_extra);
    ...
    %%record.hrl record
        ...
        is_record(Info, ets_castle_rush_player_score) ->
            NewFieldList = record_info(fields, ets_castle_rush_player_score);
        is_record(Info, ets_castle_rush_rank) -> NewFieldList = record_info(fields, ets_castle_rush_rank);
        is_record(Info, ets_castle_rush_award_member) ->
            NewFieldList = record_info(fields, ets_castle_rush_award_member);
