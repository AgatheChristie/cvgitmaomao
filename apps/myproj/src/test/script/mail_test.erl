    ...
    receive
        ...
        {tcp, Socket, <<_L:16, 19002:16, Result:16, Bin/binary>>} ->
            case Result of
                ...
                1 ->
                    <<_Id:32, _Timestamp:32, L1:16, BinSName:L1/binary-unit:8, L2:16, BinTitle:L2/binary-unit:8, Len:16, BinContent:Len/binary-unit:8, GoodsTypeId:32, GoodsNum:32, Coin:32, Cash:32>> = Bin,
                    SName = binary_to_list(BinSName),
                    Title = binary_to_list(BinTitle),
                    Content = binary_to_list(BinContent),
                    io:fwrite("sname: ~p, title: ~p, content: ~p, goods_type_id:~p, goods_num:~p, coin:~p, cash:~p~n", [SName, Title, Content, GoodsTypeId, GoodsNum, Coin, Cash]);
                _ ->
