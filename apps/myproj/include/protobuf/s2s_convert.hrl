...
-define(CHAT_CAMP_S2S , 1071006). %% 势力聊天信息
-define(CHAT_LEAGUE_S2S , 1071007). %% 联盟聊天信息
-define(CHAT_PRIVATE_S2S , 1071009). %% 私人聊天信息
-define(CHAT_PRIVATE_INFO_S2S , 1071010). %% 获取私聊未读信息
-define(CHAT_PRIVATE_READ_S2S , 1071011). %% 私聊已读信息
-define(BAG_INFO_S2S , 1081001). %% 背包信息
-define(BAG_NIU_LIST_S2S , 1081002). %% 背包信息
-define(BAG_NIU_CLEAN_S2S , 1081003). %% 背包信息
-define(BAG_NIU_SHOP_S2S , 1081004). %% 背包信息
-define(BAG_NIU_BUY_S2S , 1081005). %% 背包信息
-define(BAG_BUY_GRID_S2S , 1081009). %% 购买格子
-define(BAG_ITEM_USE_S2S , 1081011). %% 使用物品
-define(BAG_ITEM_COMPOSE_S2S , 1081012). %% 合成物品
-define(BAG_ITEM_QIANGHUA_S2S , 1081013). %% 强化装备物品
-define(BAG_ITEM_DELIVER_S2S , 1081014). %% 道具交付
-define(BAG_ITEM_SELL_S2S , 1081015). %% 出售物品
